            ...
            <div class="page d-flex flex-row">
                  ...
                  <section class="main">
                        ...
                        <div class="alert alert-secondary" role="alert">
                              <strong>Note:</strong> IF ANY OF YOUR WHISHED LIST SUBJECT IS NOT MENTIONED IN THE BELOW LIST PLEASE CONTACT THE ADMINSTARTOR
                        </div>
                        <div class="project-head">
                              ...
                              <div class="activeformque">
                                    ...
                                    <table class="table table-striped">
                                          <thead>
                                                <tr class="thead">
                                                      <th scope="col" class="head">SR</th>
                                                      <th scope="col" class="head">Code</th>
                                                      <th scope="col" class="head">Name</th>
                                                      <th scope="col" class="head">Type</th>
                                                      <th scope="col" class="head">Credits</th>
                                                </tr>
                                          <tbody>
                                                <tr>
                                                      <td>1</td>
                                                      <td>EM 4</td>
                                                      <td>Enggineering Mathematics</td>
                                                      <td>Regular</td>
                                                      <td>3</td>
