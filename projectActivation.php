...
<head>
      ...
      <title>Administrator | Activate</title>
                  ...
                  <section class="main">
                        <div class="project-head d-flex justify-content-between align-items-center">
                              <div>
                                    ...
                                    <span class="badge rounded-pill text-bg-secondary">activation</span>
                              </div>
                        ...
                        <div class="alert alert-dark" role="alert">
                              <strong>Note:</strong> ADMIN IS REQUIRED TO FILL THE DETAIL OF DAY, DATE AND TIME AS PER IST
                        </div>
                        <div class="project-head">
                              <div class="activeformque">
                                    <h3>Form to be Activated:</h3>
                                    <div class="activeformque">
                                          <div class="container mt-5 mx-5" style="margin-bottom: 3rem;">
                                                <div class="row">
                                                      <div class="col-md-6">
                                                            <div class="form-group">
                                                                  <label for="fromDate">From:</label>
                                                                  <div class="input-group">
                                                                        <input type="date" id="fromDate" class="form-control datetimepicker-input" />
                                                                        <input type="time" id="fromTime" class="form-control datetimepicker-input" />
                                                                  </div>
                                                            </div>
                                                      </div>
                                                      <div class="col-md-6">
                                                            <div class="form-group">
                                                                  ...
                                                                  <div class="input-group">
                                                                        <input type="date" id="toDate" class="form-control datetimepicker-input" />
                                                                        <input type="time" id="toTime" class="form-control datetimepicker-input" />
                                                                  </div>
                                                            </div>
                                                      </div>
                                                </div>
